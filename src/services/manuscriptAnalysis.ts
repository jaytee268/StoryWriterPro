...
export interface ManuscriptReviewArtifactDetail { artifactId: string; artifactType: ManuscriptAnalysisArtifactType; title: string; body: string; chapterId?: string; sceneId?: string; excerpt?: string; confidence?: number; reason?: string; sourceReferenceId?: string; startOffset?: number; endOffset?: number; supportingSignals?: string[]; contradictingSignals?: string[]; alternativeGenres?: string[]; audienceNotes?: string[]; warnings?: string[]; }

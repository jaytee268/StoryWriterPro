...
export interface ProjectContext { projectId: string; currentScene?: Scene; currentChapter?: Chapter; relevantEntities: StoryEntity[]; relevantSources: StorySourceReference[]; openPlotThreads: StoryEntity[]; possibleContradictions: StoryEntity[]; lore?: LoreMetadata[]; entityRelations?: StoryEntityRelation[]; characterProfiles?: CharacterProfile[]; characterStates?: CharacterSceneState[]; projectStyle?: ProjectStyle; styleReferences?: StyleReference[]; }

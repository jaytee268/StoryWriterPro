...
export interface Project { id: string; title: string; author: string; description: string; updatedAt: string; wordCount: number; openWarnings: number; bibleProgress: number; }
export interface Book { id: string; projectId: string; title: string; volume: number; }
export interface Chapter { id: string; bookId: string; title: string; orderIndex: number; scenes: Scene[]; }
export interface Scene { id: string; chapterId: string; title: string; orderIndex: number; content: string; pov: string; location: string; storyTime: string; status: 'draft' | 'revised' | 'final'; goal: string; notes: string; }
export interface StoryEntity { id: string; name: string; type: EntityType; description: string; status: EntityStatus; confidence: number; source: string; chapter: string; scene: string; authorConfirmed: boolean; updatedAt: string; tags: string[]; }

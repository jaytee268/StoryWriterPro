...
export interface PlotThreadLifecycleProposal { id: string; runId: string; projectId: string; entityId: string; proposedStatus: PlotThreadLifecycleStatus; evidenceExcerpt: string; sourceReferenceId?: string; startOffset?: number; endOffset?: number; reason: string; reviewStatus: BibleReviewStatus; reviewedAt?: string; createdAt: string; }
...
export type ManuscriptAnalysisJobStatus = 'pending' | 'running' | 'paused' | 'completed' | 'failed' | 'cancelled';
...
export interface ManuscriptAnalysisJob { id: string; projectId: string; bookId: string; importReference: string; status: ManuscriptAnalysisJobStatus; totalUnits: number; completedUnits: number; failedUnits: number; currentUnitId?: string; providerId: string; pageMarkers: ManuscriptAnalysisPageMarker[]; createdAt: string; updatedAt: string; completedAt?: string; errorMessage?: string; }
export type ManuscriptAnalysisUnitStatus = 'pending' | 'running' | 'completed' | 'failed' | 'skipped';
export interface ManuscriptAnalysisUnit { id: string; jobId: string; projectId: string; chapterId: string; sceneId: string; orderIndex: number; pageNumber?: number; startOffset: number; endOffset: number; content: string; contentHash: string; status: ManuscriptAnalysisUnitStatus; retryCount: number; continuityRunId?: string; errorMessage?: string; createdAt: string; updatedAt: string; completedAt?: string; }
...
export interface UpdateManuscriptAnalysisJobInput { id: string; status: ManuscriptAnalysisJobStatus; currentUnitId?: string; errorMessage?: string; completedAt?: string; }
export interface UpdateManuscriptAnalysisUnitInput { id: string; status: ManuscriptAnalysisUnitStatus; retryCount?: number; continuityRunId?: string; content?: string; contentHash?: string; errorMessage?: string; completedAt?: string; }
export type ManuscriptAnalysisDraftLedgerStatus = 'proposed' | 'confirmed' | 'rejected';
export interface ManuscriptAnalysisDraftLedgerEntry { id: string; jobId: string; unitId: string; projectId: string; entityId: string; relatedEntityId?: string; stateKind: ContinuityStateKind; previousState: string; newState: string; chapterId: string; sceneId: string; startOffset?: number; endOffset?: number; confidence: number; status: ManuscriptAnalysisDraftLedgerStatus; createdAt: string; updatedAt: string; }

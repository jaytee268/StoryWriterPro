...
export interface ProvisionalMergeProposal { id: string; jobId: string; projectId: string; leftProvisionalEntityId: string; rightProvisionalEntityId?: string; existingEntityId?: string; reason: string; confidence: number; reviewStatus: Exclude<ProvisionalReviewStatus, 'merged'>; createdAt: string; }

...
export interface ContinuityStateLedgerEntry { id: string; projectId: string; entityId: string; relatedEntityId?: string; stateKind: ContinuityStateKind; previousState: string; newState: string; chapterId?: string; sceneId?: string; startOffset?: number; endOffset?: number; sourceReferenceId?: string; status: ContinuityStateStatus; confidence: number; authorConfirmed: boolean; createdAt: string; updatedAt: string; }
...
export interface ContinuityReviewFinding { id: string; runId: string; projectId: string; chapterId?: string; sceneId?: string; findingType: ContinuityReviewFindingType; severity: ContinuityReviewSeverity; subjectEntityId?: string; relatedEntityIds: string[]; relatedStateIds: string[]; relatedRuleIds: string[]; objectiveConflict: string; loreExplanations: string[]; evidenceExcerpt: string; counterEvidenceExcerpts: string[]; confidence: number; startOffset?: number; endOffset?: number; reason: string; reviewStatus: ContinuityReviewStatus; userDecision?: string; createdAt: string; updatedAt: string; }
...
export interface PlotThreadLifecycleProposal { id: string; runId: string; projectId: string; entityId: string; proposedStatus: PlotThreadLifecycleStatus; evidenceExcerpt: string; startOffset?: number; endOffset?: number; reason: string; reviewStatus: BibleReviewStatus; reviewedAt?: string; createdAt: string; }
...
export interface ContinuityStateChangeProposal { entityId: string; relatedEntityId?: string; stateKind: ContinuityStateKind; previousState: string; newState: string; confidence: number; evidenceExcerpt: string; startOffset?: number; endOffset?: number; reason: string; }
export interface ContinuityContradictionProposal { findingType: Exclude<ContinuityReviewFindingType, 'character_deviation' | 'insufficient_evidence'>; subjectEntityId?: string; relatedEntityIds: string[]; relatedStateIds: string[]; objectiveConflict: string; evidenceExcerpt: string; counterEvidenceExcerpts: string[]; confidence: number; startOffset?: number; endOffset?: number; reason: string; }
export interface ContinuityLoreMatch { ruleId: string; rationale: string; confidence: number; }
export interface ContinuityPlotThreadChangeProposal { entityId: string; proposedStatus: Exclude<PlotThreadLifecycleStatus, 'resolved'>; evidenceExcerpt: string; startOffset?: number; endOffset?: number; reason: string; confidence: number; }

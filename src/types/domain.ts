...
export interface Book { id: string; projectId: string; title: string; volume: number; primaryGenreId?: string; secondaryGenreIds: string[]; customGenreNames: string[]; genreSource?: BookGenreSource; genreConfidence?: number; genreReason?: string; genreAuthorConfirmed: boolean; genreDetectedAt?: string; createdAt?: string; updatedAt?: string; }
export interface SaveBookGenresInput { bookId: string; projectId: string; primaryGenreId?: string; secondaryGenreIds: string[]; customGenreNames: string[]; genreSource?: BookGenreSource; genreConfidence?: number; genreReason?: string; genreAuthorConfirmed: boolean; genreDetectedAt?: string; }
...
export interface ProvisionalRelation { id: string; jobId: string; projectId: string; sourceProvisionalEntityId: string; targetProvisionalEntityId: string; relationType: string; label: string; confidence: number; reviewStatus: Exclude<ProvisionalReviewStatus, 'merged'>; sourceReferenceId?: string; createdAt: string; updatedAt: string; }
...
export interface ProvisionalEvent { id: string; jobId: string; projectId: string; passageUnitId: string; chapterId: string; sceneId: string; title: string; summary: string; participantEntityIds: string[]; startOffset: number; endOffset: number; confidence: number; reviewStatus: Exclude<ProvisionalReviewStatus, 'merged'>; sourceReferenceId?: string; createdAt: string; }
...
export interface DetectBookGenreInput { projectId: string; bookId: string; chapterSummaries: NarrativeSummary[]; entities: StoryEntity[]; plotThreads: PlotThreadLifecycleProposal[]; confirmedRules: ProjectRule[]; timelineEvents: PersistentTimelineEvent[]; bookSynthesis?: ManuscriptSynthesisResult; projectStyle?: ProjectStyle; }

...
export interface ContinuityReviewRun { id: string; projectId: string; chapterId?: string; sceneId?: string; sourceKind: ContinuityReviewSourceKind; contentHash: string; startOffset?: number; endOffset?: number; providerId: string; status: BibleRunStatus; createdAt: string; completedAt?: string; errorMessage?: string; }

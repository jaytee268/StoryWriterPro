...
export interface ContinuityReviewFinding { id: string; runId: string; projectId: string; chapterId?: string; sceneId?: string; findingType: ContinuityReviewFindingType; severity: ContinuityReviewSeverity; subjectEntityId?: string; relatedEntityIds: string[]; relatedStateIds: string[]; relatedRuleIds: string[]; objectiveConflict: string; loreExplanations: string[]; evidenceExcerpt: string; startOffset?: number; endOffset?: number; reason: string; reviewStatus: ContinuityReviewStatus; userDecision?: string; createdAt: string; updatedAt: string; }

...
pub struct UpdateManuscriptAnalysisJobInput {
    ...
    pub phase_errors: Option<serde_json::Value>,
    pub current_unit_id: Option<String>,
    pub last_successful_unit_id: Option<String>,
    pub error_message: Option<String>,
    pub completed_at: Option<String>,
...
pub struct ProvisionalRelation {
    ...
    pub canonical_source_entity_id: Option<String>,
    pub canonical_target_entity_id: Option<String>,
...
pub struct ProvisionalEvent {
    ...
    pub canonical_participant_entity_ids: Vec<String>,
    pub start_offset: i64,
    pub end_offset: i64,
    pub confidence: f64,
    pub review_status: String,

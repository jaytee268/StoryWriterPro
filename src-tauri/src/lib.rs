...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::create_project_source_document,
            commands::list_project_source_documents,
            commands::create_project_source_reference,
            ...
            commands::get_ai_setup_state,
            commands::save_ai_setup_state,
            commands::get_openai_api_key_status,
            commands::set_openai_api_key,
            commands::delete_openai_api_key,
            commands::test_openai_api_connection,
            commands::run_openai_api_task,
            ...
            commands::create_lore_crafter_run,
            commands::list_lore_crafter_runs,
            commands::get_lore_crafter_run,
            commands::update_lore_crafter_run,
            commands::list_lore_crafter_clarifications,
            commands::save_lore_crafter_clarifications,
            commands::save_lore_crafter_source,
            commands::list_lore_crafter_sources,
            commands::save_lore_sheet_draft,
            commands::save_lore_sheet_with_items,
            commands::get_lore_sheet_draft,
            commands::save_lore_sheet_items,
            commands::list_lore_sheet_items,
            commands::review_lore_sheet_item,
            commands::save_excluded_content_decision,
            commands::list_excluded_content_decisions,
            commands::save_project_content_proposal,
            commands::list_project_content_proposals,
            ...
            commands::save_reveal_contract,
            commands::activate_reveal_contract_bundle,
            commands::get_reveal_contract,
            commands::list_reveal_contracts,
            commands::retire_reveal_contract,
            commands::save_reveal_audience_state,
            commands::list_reveal_audience_states,
            commands::save_reveal_clue_rule,
            commands::list_reveal_clue_rules,
            commands::build_reveal_context,
            commands::validate_reveal_compliance_result,
            commands::save_reveal_compliance_run,
            commands::list_reveal_compliance_runs,
            ...
            commands::list_continuity_finding_decisions,
            commands::apply_continuity_finding_decision,
            commands::reconcile_continuity_text_correction,
            commands::list_continuity_canon_change_audits,
            ...
            commands::save_manuscript_analysis_phase_result,
            commands::list_manuscript_analysis_phase_results,
            ...
            commands::save_manuscript_analysis_completion_report,
            commands::get_manuscript_analysis_completion_report,
            commands::create_manuscript_structure_run,
            commands::update_manuscript_structure_run,
            commands::list_manuscript_structure_runs,
            commands::list_manuscript_structure_proposals,
            ...
            commands::save_provisional_merge_proposal,
            commands::save_provisional_relation,
            commands::save_provisional_event,
            commands::list_timeline_events,
            commands::save_timeline_event,
            commands::review_timeline_event,
            commands::list_story_graph_edges,
            commands::save_story_graph_edge,
            commands::review_story_graph_edge,
            commands::list_mindmap_layouts,
            commands::save_mindmap_layout,
